...
import gr.manos.guide.restapi.utils.TimeProvider;
...
//                .setAudience(audience)
    ...
    public long getExpiredIn() {
        return timeProvider.now().getTime() + EXPIRES_IN * 1000;
    }
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        ...
        return (
                ...
                username.equals(userDetails.getUsername()) &&
                        !isCreatedBeforeLastPasswordReset(created, springSecurityUser.getLastPasswordResetDate())
        );
    }
