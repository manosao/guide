package gr.manos.guide.restapi.security.jwt1;

import gr.manos.guide.restapi.security.jwt1.JWTAuthenticationFilter;
import gr.manos.guide.restapi.security.jwt1.JWTAuthorizationFilter;
...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and().formLogin().loginPage("/token/login")
